  ...
  function getPreparedTransactions() {
    ...
    foreach ($response->data as $key => $value) {
      ...
      array_push($transactions, (object) [
        ...
        'amount_fiat' => $type == 'withdrawal' ? $attributes->best_fee_collection->attributes->bfc_market_value_eur : floatVal($attributes->amount_eur),
        // NONE (withdrawal) OR amount_coin (sell, buy, deposit, transfer as reward)
        ...
        'price' => $type == 'deposit' || $type == 'transfer' ? 0 : $type == 'withdrawal' ? $attributes->best_fee_collection->attributes->best_current_price_eur : floatVal($attributes->trade->attributes->price),
