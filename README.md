...
| typescript | 3.5.3           | 3.7.4          | @angular-devkit/build-angular@0.803.22" has incorrect peer dependency "typescript@>=3.1 < 3.6 |
| typescript | 3.5.3           | 3.7.4          | @angular-devkit/build-angular > @ngtools/webpack@8.3.22" has incorrect peer dependency "typescript@>=3.4 < 3.6 |
